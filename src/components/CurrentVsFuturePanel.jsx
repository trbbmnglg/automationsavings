    ...
    <div className={`${cardStyle} flex flex-col`}>
      <div className="p-6 md:p-8 flex-1">
        ...
        <div className="space-y-6">
          <div className={`${isDarkMode ? 'bg-[#0F172A]' : 'bg-accenture-gray-off-white'} p-5 rounded-none border ${borderMuted} shadow-[inset_0_1px_3px_rgba(0,0,0,0.02)]`}>
          ...
          <div className={`${isDarkMode ? 'bg-accenture-purple-darkest/20 border-accenture-purple-dark/40' : 'bg-accenture-purple-lightest/50 border-accenture-purple-light/60'} p-5 rounded-none border shadow-[inset_0_1px_3px_rgba(59,130,246,0.05)]`}>
