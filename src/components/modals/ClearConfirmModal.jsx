...
export default function ClearConfirmModal() {
  ...
  return (
    ...
    >
      <div className={`${isDarkMode ? 'bg-[#1E293B] border-accenture-gray-dark' : 'bg-white border-accenture-gray-light'} rounded-none shadow-2xl w-full max-w-sm overflow-hidden border p-8 text-center`}>
        <div className="mx-auto w-16 h-16 bg-[#fff0f6] dark:bg-accenture-pink/20 flex items-center justify-center text-accenture-pink dark:text-accenture-pink mb-6"><AlertTriangle size={32} /></div>
