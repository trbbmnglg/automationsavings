     ...
     >
       <div className={`${isDarkMode ? 'bg-[#1E293B] border-accenture-gray-dark' : 'bg-white border-accenture-gray-light'} rounded-[32px] shadow-2xl w-full max-w-xl overflow-hidden border flex flex-col max-h-[90vh]`}>
         ...
         <div className={`px-6 py-5 ${isDarkMode ? 'bg-[#0F172A] border-accenture-gray-dark' : 'bg-accenture-gray-off-white border-accenture-gray-light'} border-t flex justify-between items-center shrink-0`}>
           ...
           <button onClick={handleSave} className="bg-accenture-purple hover:bg-accenture-purple text-white px-6 py-3 font-bold transition-colors shadow-md">Apply Advanced Costs</button>
         </div>
       </div>
     </div>
   );
